 ...
 * Slug: clarke/call-to-action-vertical-light
 * Categories: clarke_cta
*/
?>

<!-- wp:group {"align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|80","right":"var:preset|spacing|80","bottom":"var:preset|spacing|80","left":"var:preset|spacing|80"},"margin":{"top":"0"}}},"backgroundColor":"white","layout":{"contentSize":"720px","wideSize":"1440px","type":"constrained"}} -->
