...
<div class="wp-block-group alignfull" style="margin-top:0;padding-top:var(--wp--preset--spacing--80);padding-right:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--80);padding-left:var(--wp--preset--spacing--80)">
	...
	<!-- wp:heading -->
	<h2>Testimonials from <mark style="background-color:rgba(0, 0, 0, 0)" class="has-inline-color has-primary-color">happy clients</mark>.</h2>
	<!-- /wp:heading -->
	...
	<div class="wp-block-columns" style="margin-top:var(--wp--preset--spacing--70)">
		...
		<div class="wp-block-column">
			...
			<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|60","padding":{"top":"var:preset|spacing|60","right":"var:preset|spacing|60","bottom":"var:preset|spacing|60","left":"var:preset|spacing|60"}},"border":{"radius":"12px"}},"backgroundColor":"gray","layout":{"type":"flex","flexWrap":"nowrap","verticalAlignment":"center"}} -->
			<div class="wp-block-group has-gray-background-color has-background" style="border-radius:12px;padding-top:var(--wp--preset--spacing--60);padding-right:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--60);padding-left:var(--wp--preset--spacing--60)">
				...
				<div class="wp-block-group">
					...
					<p style="font-style:italic;font-weight:500">— Jane Doe</p>
					<!-- /wp:paragraph -->
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group has-gray-background-color has-background" style="border-radius:12px;padding-top:var(--wp--preset--spacing--60);padding-right:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--60);padding-left:var(--wp--preset--spacing--60)">
				...
				<div class="wp-block-group">
					...
					<!-- wp:paragraph {"style":{"typography":{"fontStyle":"italic","fontWeight":"500"}}} -->
					<p style="font-style:italic;font-weight:500">— Thomas Anderson</p>
					<!-- /wp:paragraph -->
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group has-gray-background-color has-background" style="border-radius:12px;padding-top:var(--wp--preset--spacing--60);padding-right:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--60);padding-left:var(--wp--preset--spacing--60)">
				...
				<div class="wp-block-group">
					...
					<!-- wp:paragraph {"style":{"typography":{"fontStyle":"italic","fontWeight":"500"}}} -->
					<p style="font-style:italic;font-weight:500">— John McClane</p>
					<!-- /wp:paragraph -->
