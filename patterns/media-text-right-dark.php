<?php
/**
 * Title: Media Text (Right, dark)
 * Slug: clarke/media-text-right-dark
...
<div class="wp-block-group alignfull has-white-color has-dark-gray-background-color has-text-color has-background" style="margin-top:0;padding-top:var(--wp--preset--spacing--80);padding-right:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--80);padding-left:var(--wp--preset--spacing--80)">
	...
	<div class="wp-block-media-text has-media-on-the-right is-stacked-on-mobile"><figure class="wp-block-media-text__media">
		...
		<div class="wp-block-media-text__content">
			...
			<p class="has-medium-gray-color has-text-color" style="font-style:normal;font-weight:500">For Individuals</p>
			<!-- /wp:paragraph -->
